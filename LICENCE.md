...
- View and study this source code
- Modify it for personal, non-distributed use
- Submit contributions to this repository via pull request
...
- Redistribute this software under a different name
...
## Conditions for Forks and Derivative Works
...
any kind. The author accepts no responsibility for any
damage or data loss arising from its use.

Guild Wars is a registered trademark of NCSoft
Corporation. GW Observer is an unofficial fan tool
and is not affiliated with NCSoft or ArenaNet.

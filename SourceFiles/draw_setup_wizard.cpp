...
namespace
{
    ...
    static DatValidation ValidateDatPath(const std::string& path)
    {
    ...
    static FolderValidation ValidateMatchFolder(const std::string& path)
    {
    ...
    static std::string TryAutoDetect()
    {
